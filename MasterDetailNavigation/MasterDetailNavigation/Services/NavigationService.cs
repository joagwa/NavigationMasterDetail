...
namespace MasterDetailNavigation.Services
{
    public class NavigationService : INavigationService
    {
        ...
        public void InitCurrentNavigationPage (BaseViewModel baseViewModel)
        {
            if (baseViewModel != null)
            {
                ...
                foreach (var page in ((CustomMasterDetailPage)Application.Current.MainPage).MenuPages.Values)
                {
        ...
        private async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            if (CurrentNavigationPage != null)
            {
                ...
                {
                    ((CustomMasterDetailPage)CurrentPage).Detail = page;
                }
